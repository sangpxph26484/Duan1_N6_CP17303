...
//
////        HoaDonDTO hoaDonDTO =list.get(position);
////        Glide.with(view.getContext()).load(Uri.parse(hoaDonDTO.get())).into(imgItemsp);
////        txtItemtensp.setText( hoaDonDTO.getTensanpham());
////        txtItemgiasp.setText( hoaDonDTO.getGiatien()+"đ");
